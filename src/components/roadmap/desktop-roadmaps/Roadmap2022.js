    ...
    return (
        <Container>   
            ...
            <g id="_2022" dataName="2022" transform="translate(12 -3656.001)">
                ...
                <g id="Code_Auditing" dataName="Code Auditing" transform="translate(657 3791.001)">
                ...
                <text id="Kaddex_Beta_on_MainNet-2" dataName="Kaddex Beta on MainNet" transform="translate(-0.317 39.432)" fill="#ec1bb4" fontSize="16" font-family="Montserrat-Bold, Montserrat" font-weight="700"><tspan x="0" y="0">X-Wallet Beta</tspan></text>
                <g id="Circle-11" dataName="Circle" transform="translate(-0.317 0.432)" fill="#ec1bb4" stroke="#ec1bb4" stroke-width="8">
                    <circle cx="8" cy="8" r="8" stroke="none"/>
                    <circle cx="8" cy="8" r="4" fill="none"/>
                </g>
                </g>
                <g id="Pre_Launch_Public_Sale" dataName="Pre Launch  Public Sale" transform="translate(432.316 3929.259)">
                <text id="Pre_Launch_Public_Sale-2" dataName="Pre Launch  Public Sale" transform="translate(-0.317 23.742)" fill="#fff" fontSize="16" fontFamily={theme.fontFamily.bold} font-weight="500"><tspan x="0" y="15">KDX Liquidity </tspan><tspan x="0" y="41">Mining Programme </tspan></text>
