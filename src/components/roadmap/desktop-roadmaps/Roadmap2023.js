...
const Roadmap2023 = ({ className }) => {
  return (
    ...
    >
      ...
      {/*blue line */}
      {/* <line id="Line_585" dataName="Line 585" x2="1596" transform="translate(0 421)" fill="none" stroke={theme.colors.yellow} strokeWidth="4" /> */}

      {/*blue line */}
      <line id="Line_585" dataName="Line 585" x2="474" transform="translate(1270 16.5)" fill="none" stroke={theme.colors.yellow} strokeWidth="4" />
