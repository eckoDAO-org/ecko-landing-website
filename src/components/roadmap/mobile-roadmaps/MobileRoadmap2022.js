...
const CONFIGURATION = {
  ...
  KADDEX_V1_FULL_LAUNCH: {
    circle: 'translate(96 794)',
    text: 'translate(111 852)',
    color: '#FA41A5',
  },
  SINGLE_SIDED_LIQUIDITY: {
    circle: 'translate(260 799)',
  ...
  FLAG: {
    flag: 'translate(109 764)',
    shadow: 'translate(91 788)',
  },
};
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="376.001" height="920" viewBox="0 0 376.001 920">
      <g id="Mobile-Roadmap_2022_mobile" data-name="Roadmap 2022_mobile" transform="translate(0.001 -253)">
        <g id="Mobile-Group_68995" data-name="Group 68995">
          <path
          ...
          {/* X_WALLET_BETA */}
          <circle
            id="Mobile-Ellipse_X-Wallet_beta"
          ...
          {/* BRIDGED_ERC20 */}
          <circle
            id="Mobile-Ellipse_Bridged_ERC_20_Token_Pairs"
          ...
          />
          <text
            id="Mobile-Bridged_ERC_20_Token_Pairs-20_Token_Pairs"
          ...
          {/* KDX_LIQUIDITY_MINING_PROGRAMME */}
          <circle
            id="Mobile-Ellipse_KDX_Liquidity_Mining_Programme"
          ...
          {/* LENDING_AND_BORROWING_FUNCTIONALITIES */}
          <circle
            id="Mobile-Ellipse_Lending_borrowing_functionalities"
