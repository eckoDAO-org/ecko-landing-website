...
import Roadmap2024 from './desktop-roadmaps/Roadmap2024';
import MobileRoadmap2024 from './mobile-roadmaps/MobileRoadmap2024';
...
const Roadmap = () => {
  ...
  const [selectedRoadmapId, setSelectedRoadmapId] = useState(R_2024.id);
    ...
    >
      ...
      {roadmapType === 'kaddex' ? (
        <RoadmapContainer id="roadmaps-container" style={{ width }} mobileStyle={{ minHeight: 600 }} translateXRoadmap={translateXRoadmap}>
          ...
          <FlexContainer style={{ minWidth: width }} id={`roadmap-${R_2024.id}`}>
            {width >= theme.mediaQueries.mobilePixel ? <Roadmap2024 className="roadmap-desktop" /> : <MobileRoadmap2024 color={R_2024.color} />}
          </FlexContainer>
