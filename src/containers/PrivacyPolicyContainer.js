    ...
    <OuterContainer id='proof_of_dex'>
      ...
      <Intro gap={40}>
        ...
        <Label fontSize={20} fontFamily='medium'>
          Kaddex US Holdings Inc., a Delaware corporation, Kaddex DAO, and their
          affiliates (collectively, “Kaddex” or “We”), respect your privacy and
          ...
          from you or that you may provide when you visit the websites
          www.xwallet.kaddex.com or www.kaddex.com (collectively, the
          “Websites”), the X-Wallet application, or any content, functionality,
          and services offered on or through the Websites or such application
          (collectively, the “Kaddex Services”), and our practices for
          ...
          Kaddex Services or you and Kaddex in relation to the Kaddex Services.
          <br />
          ...
          website or application operated by any third party; or <br />
          ...
          through the Kaddex Services, except to the extent we collect
          ...
          to use the Kaddex Services. By accessing or using the Kaddex Services,
          you agree to this Privacy Policy. This Privacy Policy may change from
          time to time (see Changes to Our Privacy Policy). Your continued use
          of the Kaddex Services after we make changes is deemed to be
        ...
        <Label fontSize={20} fontFamily='medium'>
          <p>
            The Kaddex Services are not intended for persons under 18 years of
            age. No one under age 18 should provide any information to or
            through the Kaddex Services. We do not knowingly collect personal
            information from persons under 18. If you are under 18, do not use
            or provide any information on the Websites or through any of the
            Websites’ or the Kaddex Services’ features, register on the Websites
            or otherwise through the Kaddex Services, make any purchases through
            the Kaddex Services, use any interactive or public comment features
            of the Kaddex Services, or provide any information about yourself to
            us, including your name, address, telephone number, email address,
            or any screen name or user name you may use. If you believe we might
            have any information from or about a person under 18, please contact
            us at [info@kaddex.com] .<br />
            <br />
            California residents may have additional rights regarding the
            collection and sale of their personal information under the
            California Consumer Privacy Act of 2018, as amended. Please see Your
        ...
        <Label fontSize={20} fontFamily='medium'>
          <p>
            ...
            <br />
            ● Automatically as you navigate through the Kaddex Services.
            ...
            <br />
            <br />● Information that you provide by filling in forms on our
            Websites and other features of the Kaddex Services. This includes
            information provided at the time of registering to use the Kaddex
            Services, subscribing to our services, posting material (including
            User Contributions), or requesting further services. We may also ask
            you for information when you report a problem with the Kaddex
            Services.
            <br />
            <br />
            ...
            Technologies <br />
            <br />
            As you navigate through and interact with the Kaddex Services, we
            ...
            <br />
            <br />
            ● Details of your visits to our Websites and other features of the
            Kaddex Services, including traffic data, location data, logs, and
            other communication data and the resources that you access and use
            through the Kaddex Services.
            <br />
            ● Information about your computer or device and internet connection,
            ...
            and does not include Personal Information other than your location,
            but we may maintain it or associate it with Personal Information we
            collect in other ways, receive from third parties, or that is public
            on the blockchain. It helps us to improve the Kaddex Services and to
            ...
            the Kaddex Services according to your individual interests.
            <br />
            ...
            include:
            <br />
            <br />● <strong>Cookies (or browser cookies).</strong> A cookie is a
            small file placed on the hard drive of your computer. You may refuse
            to accept browser cookies by activating the appropriate setting on
            your browser. However, if you select this setting you may be unable
            to access certain parts of the Kaddex Services. Unless you have
            adjusted your browser setting so that it will refuse cookies, our
            system will issue cookies when you direct your browser to the
            Websites. <br />● <strong>Flash Cookies.</strong> Certain features
            of the Kaddex Services may use local stored objects (or Flash
            cookies) to collect and store information about your preferences and
            navigation to, from, and on the Websites. Flash cookies are not
            ...
            settings for Flash cookies, see Tracking Technologies and
            Advertising.
            <br />● <strong>Web Beacons.</strong> Pages of the Websites and our
            ...
            that permit Kaddex, for example, to count users who have visited
            ...
            content and verifying system and server integrity). <br />
            <br />
        ...
        <Label fontSize={20} fontFamily='medium'>
          Some content or applications, including advertisements and
          decentralized applications, on the Kaddex Services are served by
          ...
          technologies to collect information about you when you use the Kaddex
          Services. The information they collect may be associated with your
          ...
          advertising or other targeted content. <br />
          <br />
          ...
          targeted advertising from many providers, see Tracking Technologies
          and Advertising.
        </Label>
        <Label fontSize={32} fontFamily='medium'>
        ...
        <Label fontSize={20} fontFamily='medium'>
          ...
          <br />
          <br />
          ● To present the Kaddex Services and its contents, including customer
          support, to you.
          <br />
          ...
          <br />
          ● Customize, measure, and improve the Kaddex Services, including
          content and layout.
          <br />
          ● To prevent and investigate potentially prohibited or illegal
          activities, and/or violations of our terms of use.
          <br />
          ...
          <br />
          ● To notify you about changes to the Kaddex Services or any products
          or services we offer or provide though it.
          <br />
          ● To allow you to participate in interactive features of the Kaddex
          Services.
          <br />
          ● In any other way we may describe when you provide the information.
          <br />
          ● For any other purpose with your consent, including as provided in
          our terms of use.
          <br />
          <br />
        ...
        <Label fontSize={20} fontFamily='medium'>
          ...
          of some or all of Kaddex’s assets, whether as a going concern or as
          part of bankruptcy, liquidation, or similar proceeding, in which
          Personal Information held by Kaddex about the Kaddex Services’ users
          ...
          ([https://kaddex.com/terms-of-use]) and other agreements.
          <br />● If we believe disclosure is necessary or appropriate to
          protect the rights, property, or safety of Kaddex, our customers, or
        ...
        <Label fontSize={20} fontFamily='medium'>
          ...
          some parts of the Kaddex Services may then be inaccessible or not
          function properly.
        </Label>
        <Label fontSize={32} fontFamily='medium'>
        ...
        <Label fontSize={20} fontFamily='medium'>
          <p>
            ...
            your account.
            <br />
            <br /> You may also send us an email at [info@kaddex.com] to request
            ...
            also deleting your account. We may not accommodate a request to
            ...
            <br />
            <br />
            If you delete your User Contributions, copies of your User
            Contributions may remain viewable in cached and archived pages, or
            might have been copied or stored by others. Proper access and use of
            information provided through the Kaddex Services, including User
            Contributions, is governed by our terms of use
            ([https://kaddex.com/terms-of-use]).
            <br />
            <br />
        ...
        <Label fontSize={20} fontFamily='medium'>
          ...
          learn more about your California privacy rights, see the California
          Policy Notice.
        </Label>
        <Label fontSize={32} fontFamily='medium'>
          Data Security
        ...
        <Label fontSize={20} fontFamily='medium'>
          ...
          certain parts of the Kaddex Services, you are responsible for keeping
          ...
          public areas of the Kaddex Services like message boards. The
          ...
          Information transmitted through the Kaddex Services. Any transmission
          ...
          contained on the Kaddex Services.
        </Label>
        <Label fontSize={32} fontFamily='medium'>
        ...
        <Label fontSize={20} fontFamily='medium'>
          ...
          the Websites’ home pages. If we make material changes to how we treat
          ...
          notice on the Websites’ home pages. The date the Privacy Policy was
          ...
          address for you, and for periodically visiting this Privacy Policy to
        ...
        <Label fontSize={20} fontFamily='medium'>
          <p>
            The following provisions supplement the information contained in
            this Privacy Policy and apply solely to all visitors, users, and
            others who reside in the State of California. We adopt these
            provisions to comply with the California Consumer Privacy Act of
            2018 (“
            <strong>CCPA</strong>”), and any terms defined in the CCPA have the
            same meaning when used in this notice. The CCPA provides consumers
            (California residents) with specific rights regarding their personal
            information. This section describes your CCPA rights and explains
            how to exercise those rights. We are collecting your personal
            information and sensitive personal information to support our
            business operations, including for the business purposes{' '}
            {/* listed
            below and  */}
            in the Privacy Policy. We will not sell the personal information we
            collect. We also will not share it with third parties for
            cross-context behavioral advertising. We will not sell the sensitive
            personal information we collect. We also will not share it with
        ...
        <Label fontSize={20} fontFamily='medium'>
          ...
          <br />● Suggest that you may receive a different price or rate for
        ...
        <Label fontSize={20} fontFamily='medium'>
          <p>
            ...
            consumer request (via email to [info@kaddex.com]), we will disclose
            to you:
            <br />
            <br />
            ...
            identifying the personal information categories that each category
        ...
        <Label fontSize={20} fontFamily='medium'>
          ...
          certain exceptions, as described in this Privacy Policy. Once we
          receive and confirm your verifiable consumer request (see Accessing
          and Correcting Your Information), we will delete (and direct our
        ...
        <Label fontSize={20} fontFamily='medium'>
          <p>
            ...
            <br />
            <br />
            If you have any questions about this notice or need to access it in
            an alternative format due to having a disability, please contact
            [info@kaddex.com].
            <br />
            <br />
            June 29, 2022
